...
public class OutputTest extends TestBase {
    ...
    public void getRecordDescription() {
        ...
        assertEquals(JoyConImageOutput.SENSOR_OUTPUT_NAME, recordDescription.getName());
        assertEquals(JoyConImageOutput.SENSOR_OUTPUT_LABEL, recordDescription.getLabel());
        assertEquals(JoyConImageOutput.SENSOR_OUTPUT_DESCRIPTION, recordDescription.getDescription());
    }
